/**
 * CreateAdaptorStageExResponseType.java
 *
...
public class CreateAdaptorStageExResponseType  implements java.io.Serializable {
    ...
    /**
     * Gets the operationResponse value for this CreateAdaptorStageExResponseType.
     * 
     * @return operationResponse   * return value for this operation
     */
    ...
    /**
     * Sets the operationResponse value for this CreateAdaptorStageExResponseType.
     * 
     * @param operationResponse   * return value for this operation
     */
    ...
    /**
     * Gets the createdModule value for this CreateAdaptorStageExResponseType.
     * 
     * @return createdModule   * description of created adaptor stage
     *                         		(includes product module)
     */
    ...
    /**
     * Sets the createdModule value for this CreateAdaptorStageExResponseType.
     * 
     * @param createdModule   * description of created adaptor stage
     *                         		(includes product module)
     */
    ...
    /**
     * Gets the objectKey value for this CreateAdaptorStageExResponseType.
     * 
     * @return objectKey   * object key of created adaptor stage
     *             					(includes product module)
     */
    ...
    /**
     * Sets the objectKey value for this CreateAdaptorStageExResponseType.
     * 
     * @param objectKey   * object key of created adaptor stage
     *             					(includes product module)
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateAdaptorStageExResponseType)) return false;
        CreateAdaptorStageExResponseType other = (CreateAdaptorStageExResponseType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateAdaptorStageExResponseType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:de:msg:pm:designer:services", "CreateAdaptorStageExResponseType"));
